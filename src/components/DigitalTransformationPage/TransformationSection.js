    ...
    <Box sx={
      ...
      <Box className="container bridal-container" sx={{
        ...
        <Grid2 container xs={6}>
          ...
          <p>Suite of digital wedding planning tools <HiArrowRight className='arrow-right' /> </p>
          <p>Ecommerce platform migration and configuration <HiArrowRight className='arrow-right' /> </p>
        </Grid2>
      </Box>
      <div className="hr"></div>
      <Box className="container pasco-container" sx={{
        color: 'white',
        textAlign: 'left'
      }}>
        ...
        <img src="https://images.unsplash.com/photo-1558611997-dd5b20e08c71?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80" alt="welding" />
      </Box>
      <div className="hr"></div>
      <Box className="container logos-container" sx={{
        color: 'white',
        textAlign: 'left'
      }}>

        <img src="https://bilberrry.com/wp-content/uploads/2022/08/logos.png" alt="welding" />
      ...
      <div className="hr"></div>
      <Box className="container notes-container" sx={{
        color: 'white',
        textAlign: 'left',
        justifyContent: 'space-between',
        ...
        <h2>Notes</h2>
        <Grid2 container xs={6}>
          <p>How we approach new design + development initiatives<HiArrowRight className='arrow-right' /> </p>
          <p>The end of enterprise software<HiArrowRight className='arrow-right' /> </p>
          <p>Why digital transformations fail<HiArrowRight className='arrow-right' /> </p>
