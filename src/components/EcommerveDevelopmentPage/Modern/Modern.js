                ...
                <Grid2 sx={{
                    ...
                    <Grid2 xs={6} sx={{
                        ...
                        <div className='modern-title-div'>
                            <h3 className='modern-title'>Our approach to
                                modern ecomm</h3>
                        </div>
                    </Grid2>
                    <Grid2 xs={6} sx={{
                        ...
                        {desc.map((descObj, i) => <div key={i}>
                            <div className="modern-line"></div>
                            <div className="modern-nav-button" onClick={() => {
                                test(i)
                                setOpenDesc(!openDesc)
                            }}>
                                <p>{descObj.title}</p>
                                <div>
                                    {openDesc && selectedDesc === i ? <RemoveIcon className='add-icon' /> : <AddIcon className='add-icon' />}
                                </div>

                            </div>
                            <div>
                                {openDesc && selectedDesc === i ? <p className='modern-text text-focus-in'>{desc[i].text}</p> : ''}
                            </div>
