			...
			<div className={` ${open === null ? "dropdown-content-hidden" : open ? "dropdown-content-opened" : "dropdown-content-closed"}`}>
				<div className="container">
					<div className="services-container">
						...
						<div>
							<h3 onClick={() => handlePage("services", "/ecommerce-development")}>Ecommerce Development</h3>
							<p>Flexible and intelligent B2B and B2C, omnichannel, and mobile commerce solutions that center your business.</p>
						</div>
						<div>
							<h3 onClick={() => handlePage("services", "/custom-software")}>Custom Software Development</h3>
			...
			<nav className="container">
				...
				<ul>
					<li
						...
						className={`${servicesPage === "services" ? "selected-page" : ""}`}
					>
						Services
					</li>
					<li
						onClick={() => handlePage("work", "/work")}
						className={`${servicesPage === "work" ? "selected-page" : ""}`}
					>
						Work
					</li>
					<li
						onClick={() => handlePage("approach", "/approach")}
						className={`${servicesPage === "approach" ? "selected-page" : ""}`}
					>
						Approach
					</li>
					<li
						onClick={() => handlePage("notes", "/notes")}
						className={`${servicesPage === "notes" ? "selected-page" : ""}`}
					>
						Notes
					</li>
					<li
						onClick={() => handlePage("about", "/about")}
						className={`${servicesPage === "about" ? "selected-page" : ""}`}
					>
						About
					</li>
					<li
						onClick={() => handlePage("contact", "/contact")}
						className={`${servicesPage === "contact" ? "selected-page" : ""}`}
					>
						Contact
					</li>
					{/* <Switch /> */}
